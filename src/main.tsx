    ...
    if (this.state.error) {
      return (
        ...
        >
          ...
          <div
            style={{
              background: 'var(--mf-surface, #111418)',
              border: '1px solid var(--mf-error, #ef4444)',
              borderRadius: 8,
              padding: 16,
              maxWidth: 800,
              width: '100%',
          ...
          <button
            ...
            style={{
              background: 'var(--mf-error, #ef4444)',
              color: '#fff',
              border: 'none',
              borderRadius: 6,
              padding: '8px 20px',
