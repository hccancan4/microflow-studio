...
describe('getDefaultParams', () => {
  ...
  it('curved_channel (radius 800, angle 90)', () => {
    expect(getDefaultParams('curved_channel')).toEqual({ radius: 800, angle: 90, width: 200, depth: 50 });
  });
  it('serpentine_mixer (turns 5, pitch 400)', () => {
    expect(getDefaultParams('serpentine_mixer')).toEqual({ channelWidth: 150, turns: 5, pitch: 400, depth: 50 });
  });
